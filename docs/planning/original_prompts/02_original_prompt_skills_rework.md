Can you add features to our life simulation system? First, let me give you context. There are instructions below on how to get context into the system, what to do, and stuff that should be documented (which you can put on CLAUDE.md or README.md). Info:
...
To get more context on the system and that plan, please start by reading the entirety of `/README.md`, `/CLAUDE.md` and `/docs/tasks/README.md`.

This will give you a very good idea of how the simulations work.
