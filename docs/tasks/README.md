...
| 078 | [Offline generator per-agent step-cost optimization](078-offline-generator-perf-optimization_DONE.md) | Performance | ✅ Done (~11–13× per-agent speedup; the driver was `activeInstanceOf`, not the event walk — see [perf notes §9](../planning/offline-generator-performance.md)) |
...
- **Objects in context:** [069](069-object-placement-tags_DONE.md) (placement-tag axis + building/business tags,
  ...
  building fill, teardown symmetry) → [071](071-building-context-action-requirements_DONE.md) (activities require
