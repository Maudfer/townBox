...
- **Depends on:** [072](072-person-targeted-action-contracts_DONE.md) (`askFirst` contract), [067](067-parameterized-requirements-and-event-payloads_DONE.md) (failure-reason payloads)
- **Blocks:** [074](074-person-targeted-actions-backfill_DONE.md)
