...
- **Blocks:** [043](043-actions-core_DONE.md)/[044](044-action-consequences-and-object-action-relationships_DONE.md) (actions trigger manual events), [046](046-brain-and-hooks.md) (hooks fire on committed events), [048](048-events-revision-hourly-migration.md) (migration of all existing events)
