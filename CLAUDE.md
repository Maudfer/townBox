...
src/
  ...
  json/
    ...
    events.json           # Engine B life-event manifest: 700 events (roles, triggers, limits, effects) (048/052/058)
  ...
  util/                   # Math.ts, tools.ts, base64.ts, random.ts, kinship.ts, compress.ts, familyGraph.ts,
                          ...
                          # predicate.ts (eligibility AST), school.ts (schedule math, 058),
