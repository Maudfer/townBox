...
export const DEFAULT_BASE_ATTRIBUTES = ['alive', 'gender', 'age', 'marital', 'employed', 'money', 'pregnant', 'homeless', 'canBeHired', 'canMoveOut', 'wantsMoreChildren', 'health', 'retired', 'hourOfDay', 'mood', 'depressed', 'healthcareCoverage', 'policeCoverage', 'jobApplications', 'recentlyTreated', 'petCount', 'foodLevel', 'restLevel'];
