...
import { compileSkills } from '../src/util/skillGraph';
import { schoolDailyGain, totalEligibleSchoolDays, SCHOOL_BASIC_CAP } from '../src/util/school';
import { TICKS_PER_YEAR } from '../src/util/time';
import { SkillManifest } from '../src/types/Skill';
