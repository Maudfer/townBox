...
import SchoolRegistry, { SchoolCandidate, SchoolSeat } from '../src/app/game/SchoolRegistry';
import { runTick } from '../src/app/game/TickRunner';

import { isSchoolAge, isSchoolDay, isSchoolInSession, schoolFactsFor } from '../src/util/school';
import { TICKS_PER_DAY } from '../src/util/time';

import { SchoolConfig, SchoolFacts } from '../src/types/School';
