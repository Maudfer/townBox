...
describe('data validation (task 039)', () => {
    ...
    test('all schemas are registered exactly once, with the expected roster', () => {
        ...
        expect(names).toEqual([
            ...
            'needs', 'objectActionRelationships', 'objectGeneration', 'objects', 'pets', 'placement', 'population', 'relationships', 'residences', 'retcons', 'routines', 'schools', 'services', 'skillInit', 'skills', 'toolAssets', 'traits',
        ]);
    });
