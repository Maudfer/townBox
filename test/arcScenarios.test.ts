import SkillBook, { DEFAULT_SKILL_MANIFEST } from '../src/app/game/SkillBook';
import SkillProgression from '../src/app/game/SkillProgression';
import JobMarket from '../src/app/game/JobMarket';
import Brain from '../src/app/game/Brain';
...
import { isSchoolDay, schoolFactsFor, totalEligibleSchoolDays, SCHOOL_BASIC_CAP } from '../src/util/school';
import { dayOfTick, TICKS_PER_DAY, TICKS_PER_YEAR } from '../src/util/time';

import { SchoolConfig } from '../src/types/School';
import { GenPerson, PopulationState } from '../src/types/Genealogy';
import { Genders } from '../src/types/Social';
import { JobPosition } from '../src/types/Work';
import { TickResult } from '../src/types/LifeEvent';
import { TilePosition, PixelPosition } from '../src/types/Position';
...
describe('objects live (tags → generation → requirements → possessions)', () => {
    ...
    test('a lend → return loop closes between residents; a consent decline mutates nothing', () => {
        ...
        const { evaluateConsent } = jest.requireActual<typeof import('../src/app/game/Consent')>('../src/app/game/Consent');
