...
describe('the curated contract table', () => {
    test('every person-targeted action is contracted with the ratified askFirst posture', () => {
        expect(personTargeted.length).toBe(26); // 18 pre-074 + hugged_person + kissed/invite (083/085) + ask-out/proposal (090) + thanked_person (094) + pickpocketed_someone (099) + shared_gossip (104)
